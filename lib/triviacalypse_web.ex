defmodule TriviacalypseWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: TriviacalypseWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/triviacalypse_web/templates",
        namespace: TriviacalypseWeb
      ...
      import TriviacalypseWeb.ErrorHelpers
      import TriviacalypseWeb.Gettext
      alias TriviacalypseWeb.Router.Helpers, as: Routes
    end
  end
